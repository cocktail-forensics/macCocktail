                ...
                <div class="text-center">
                    ...
                    <div class="card mb-3" style="max-width: 500px; margin:auto">
                        <div class="row no-gutters">
                            ...
                            <div class="col-md-8">
                            <div class="card-body">
                                <!-- <h5 class="card-title">Thank you for using macCocktail</h5> -->
                                <p class="card-text">
                                    Parsers by The Bartender (@Cocktail4n6)
                                </p>
                                <p class="card-text">
                                    Framework by Alexis Brignoni (@AlexisBrignoni) & Yogesh Khatri (@SwiftForensics)
                                </p>
                                <!--Github-->
                                <a class="btn-floating btn-git" type="button" role="button" href="https://github.com/cocktail-forensics/macCocktail" target="_blank"><i class="fab fa-github"></i> Project Home </a>
                            </div>
                            </div>
                        </div>
                    </div>
...
"""
    <div class="alert alert-light mb-4">
        <h4 class="text-center">macCocktail Contacts</h4>
